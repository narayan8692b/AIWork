...
search_tool = Tool(
    ...
    description="Performs a web search using DuckDuckGo and retrieves the latest information."
)
...
task1 = Task(
  ...
  agent=researcher,
  expected_output="A detailed AI advancements report"
)
...
task2 = Task(
  ...
  agent=writer,
  expected_output="A blog post with at least 3 paragraphs"
)
